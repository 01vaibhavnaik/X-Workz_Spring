...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <form class="w-50" action="shop" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="emailId" name="shopemail" >
        </div>
        <div class="mb-3">
            <label for="shopphId" class="form-label">Shop phNo</label>
            <input type="number" class="form-control" id="shopphId" name="shophno" >
        </div>
        <div class="mb-3">
            <label for="openId" class="form-label">Shop Open Time</label>
            <input type="number" class="form-control" id="openId" name="openingtime" >
        </div>
        <div class="mb-3">
            <label for="closeId" class="form-label">Shop Closing Time</label>
